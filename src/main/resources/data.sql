...
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('dsfhd', 'Aris', 'Kardasis');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('dfsgsdf', 'Chris', 'Giannikis');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('lshvgs', 'Tasos', 'Kampe');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('kusydgf', 'Christos', 'Vlachos');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('kasudyfg', 'George',  'Marko');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('suygfga', 'Cristiano', 'Ronaldo');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('aksdcvb', 'Lio', 'Messi');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('laIHBAHS', 'Kylian', 'Mbappe');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('wyetiauf', 'Sergio',  'Ramos');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('asdygg', 'Steven', 'Gerrard');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('asdftaysg', 'David', 'Beckham');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('asudtgax', 'John', 'Terry');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('asiodygfa', 'Giannis', 'Antetokounmpo');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('uycgaaua', 'Damian', 'Lillard');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('alydtqs', 'Khris', 'Middleton');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('laysgasjkh', 'Steph', 'Curry');
INSERT INTO app_user("user_id","first_name", "last_name") VALUES ('skdgfakl', 'Warren', 'West');

INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('JSDGA436JK', true, false, 1, 'dsfhd');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('GSDFHSDH087', true, false, 1, 'dfsgsdf');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('GPSJG9554KM', true, false, 2, 'lshvgs');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('JKGSAG4324', true, false, 2, 'kusydgf');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('ERHGWEHHH098', true, false, 3, 'kasudyfg');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('SDFNHGSAG796', true, false, 3, 'suygfga');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('DSGJHSFJG65', false, true, 1, 'aksdcvb');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('HDSFHSDH654', false, false, 1, 'laIHBAHS');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('DFSHDFHSDH65', false, false, 2, 'wyetiauf');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('HDSHSDFH543', false, true, 2, 'asdygg');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('SDFHSDFHDSH64', false, true, 3, 'asdftaysg');
INSERT INTO player("bite_code", "human", "patient_zero", "game_id", "user_id") VALUES ('DHSDFHSDFH645', false, false, 3, 'asudtgax');
