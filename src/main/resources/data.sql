INSERT INTO game("description", "name", "nw_lat", "nw_lng", "se_lat", "se_lng", "state") VALUES ('Description of game 1', 'Name Game1', 4.4, 2.5, 2.3, 4.3, 'REGISTRATION');
INSERT INTO game("description", "name", "nw_lat", "nw_lng", "se_lat", "se_lng", "state") VALUES ('Description of game 2', 'Name Game2', 3.4, 1.5, 1.2, 3.3, 'IN_PROGRESS');
INSERT INTO game("description", "name", "nw_lat", "nw_lng", "se_lat", "se_lng", "state") VALUES ('Description of game 3', 'Name Game3', 2.4, 0.5, 1.3, 2.3, 'COMPLETED');
...
INSERT INTO kill("lat", "lng", "time_of_death", "killer_id", "victim_id") VALUES (1.4, 1.5, null, 7, 8);
INSERT INTO kill("lat", "lng", "time_of_death", "killer_id", "victim_id") VALUES (1.24, 1.15, null, 1, 2);
INSERT INTO kill("lat", "lng", "time_of_death", "killer_id", "victim_id") VALUES (1.4, 1.5, null, 10, 9);
INSERT INTO kill("lat", "lng", "time_of_death", "killer_id", "victim_id") VALUES (1.4, 1.5, null, 11, 12);

INSERT INTO mission("description", "end_time", "human_visible", "zombie_visible", "name", "lat", "lng", "start_time", "game_id") VALUES ('Mission 1 description', null, true, false, 'Mission 1 name', 0.1, 0.2, null, 1);
INSERT INTO mission("description", "end_time", "human_visible", "zombie_visible", "name", "lat", "lng", "start_time", "game_id") VALUES ('Mission 2 description', null, false, true, 'Mission 2 name', 0.3, 0.4, null, 2);
INSERT INTO mission("description", "end_time", "human_visible", "zombie_visible", "name", "lat", "lng", "start_time", "game_id") VALUES ('Mission 3 description', null, true, true, 'Mission 3 name', 0.5, 0.6, null, 1);
INSERT INTO mission("description", "end_time", "human_visible", "zombie_visible", "name", "lat", "lng", "start_time", "game_id") VALUES ('Mission 4 description', null, true, false, 'Mission 4 name', 0.6, 0.8, null, 3);
...
INSERT INTO squad_check_in("end_time", "lat", "lng", "start_time", "squad_member_id") VALUES (null, 1.6, 1.5, null, 1);
INSERT INTO squad_check_in("end_time", "lat", "lng", "start_time", "squad_member_id") VALUES (null, 1.6, 1.5, null, 3);
INSERT INTO squad_check_in("end_time", "lat", "lng", "start_time", "squad_member_id") VALUES (null, 1.6, 1.5, null, 8);
